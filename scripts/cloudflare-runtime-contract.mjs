...
export const runtimeContract = {
  ...
  resources: {
    local: {
      workerName: "aspt-nine-centers-almamac",
      d1DatabaseName: "aspt-nine-centers-almamac-site",
      r2BucketName: "aspt-nine-centers-almamac-media",
      kvNamespaceName: "LOCAL_ASPT_NINE_CENTERS_ALMAMAC_SESSION_KV",
    },
    preview: {
      workerName: "aspt-nine-centers-almamac-preview",
      d1DatabaseName: "aspt-nine-centers-almamac-preview-site",
      r2BucketName: "aspt-nine-centers-almamac-preview-media",
      kvNamespaceName: "aspt-nine-centers-almamac-preview-session",
    },
    production: {
      workerName: "aspt-nine-centers-almamac-production",
      d1DatabaseName: "aspt-nine-centers-almamac-production-site",
      r2BucketName: "aspt-nine-centers-almamac-production-media",
      kvNamespaceName: "aspt-nine-centers-almamac-production-session",
    },
  },
