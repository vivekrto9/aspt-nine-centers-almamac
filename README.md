# Nine Centres — Field Almanac

`aspt-nine-centers-almamac` is the Field Almanac Human Design template for AstroPages. It pairs a scientific archival interface with the reusable Human Design chart, saved-reading, one-time Stripe purchase, Content Studio, localization, and Cloudflare runtime contracts.
